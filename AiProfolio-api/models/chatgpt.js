...
class ChatGPT {
  ...
  static async buildWebsiteFaster() {
    ...
    const [navbar, about, header, experiences, skills, projects, education] =
      await Promise.all([
        this.buildComponent(navbarTemplate, "navbar", themeData),
        this.buildComponent(aboutTemplate, "about", themeData),
        this.buildComponent(headerTemplate, "header", themeData),
        this.buildComponent(experiencesTemplate, "experiences", themeData),
        this.buildComponent(skillsTemplate, "skills", themeData),
        this.buildComponent(projectsTemplate, "projects", themeData),
